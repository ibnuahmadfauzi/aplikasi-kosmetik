...
?>
<div class="card card-outline card-primary" id="card-body">
    <div class="card-body">
...
<?php if (isset($_GET['view'])): ?>
    <div class="modal-footer">
        <button type="button" class="btn btn-primary btn-flat btn-sm cetak_nota">Cetak Nota</button>
...
<script>
    ...
    $(document).ready(function() {
        $('.cetak_nota').on('click', function() {
            // Ambil elemen modal_header dan modal_body
            const cardBody = document.getElementById('card-body');

            // Buat jendela baru untuk mencetak
            const printWindow = window.open('', '_blank');

            // Tambahkan konten modal_header dan modal_body ke jendela cetak
            printWindow.document.write(`
                <html>
                <head>
                    <title>Cetak Modal</title>
                    <style>
