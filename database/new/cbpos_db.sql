...
--
-- Host: 127.0.0.1
-- Generation Time: Dec 28, 2024 at 12:39 PM
...
CREATE TABLE `jawaban_survey` (
  ...
  `jenis_kulit` varchar(255) DEFAULT NULL,
...
INSERT INTO `pertanyaan_survey` (`id`, `pertanyaan`) VALUES
(1, 'Bagaimana kondisi kulit Anda setelah mencuci muka tanpa pelembap?'),
(2, 'Bagaimana kulit Anda bereaksi terhadap cuaca dingin atau berangin?'),
(3, 'Seberapa sering Anda mengalami jerawat?'),
(4, 'Bagaimana tampilan pori-pori wajah Anda?'),
(5, 'Bagaimana kulit Anda terasa di tengah hari tanpa penggunaan produk perawatan?'),
(6, 'Bagaimana kulit Anda merespons produk baru?');
